...
object Device extends SprayImplicits {
  ...
  /** Relay connected to a thermostat
    ...
    */
  case class Output(name : String, zone : Int, outputId : Int, `type` : OutputType.Entry, sendUpdate : Boolean,
      activateClosed : Boolean, activationTime : Int, deactivationTime : Int)
