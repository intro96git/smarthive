...
object ThermostatRequest {
  ...
  /** Returns new [[ThermostatRequest]] to initially request information.
    ...
    */
 def apply(account: AccountID, selection : Select)(implicit s : ClientSettings) : ThermostatRequest = ThermostatRequest(account, selection, None)
  ...
  /** Returns new [[ThermostatRequest]] to request information from a starting page.
    ...
    * @param s (implicit) The application global settings
    */
 def apply(account: AccountID, selection : Select, page : Int)(implicit s : ClientSettings) : ThermostatRequest = ThermostatRequest(account, selection, Some(page))
}
...
object ThermostatService {
  ...
  /** Implicitly converts the object into a [[ThermostatService]] for the [[ThermostatRequest]] request
    ...
    */
  implicit class ThermostatServiceImpl(o : ThermostatService.type)(implicit ev : LoggingBus, s : ClientSettings) extends EcobeeJsonService[ThermostatRequest,ThermostatResponse] {
